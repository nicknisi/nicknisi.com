...
[NICK: did the outside-the-harness thing bother you at the time, or did it just seem normal? Your answer here in your own words.]
...
[NICK: when you told Zack pi wasn't worth it — what was the actual reasoning at the time? Two or three sentences, unpolished, is plenty.]
...
I ported the creature comforts I actually missed: dynamic workflows, `/goal` and `/loop`, `/btw`, session auto-naming, `AskUserQuestion`, draft stashing, recap cards. I replaced the web search tool I'd been complaining about for weeks ("I hate the websearch tool we have currently" — me, August 3rd). I built `/mg`: a Severance-style "100% File Completion" animation starring a pixelated version of my CEO, with audio, because I could and because nobody could stop me. Two hours later I [posted it](https://x.com/nicknisi/status/2084377731123355695) with the only caption it deserved — the work of a Developer and Agent Experiences Engineer at WorkOS is mysterious and important.
...
Speed, cost, and model choice are the reasons people give in Slack. They're all true and none of them moved me for four months.

What did was noticing how much of my tooling existed only because I couldn't get inside the harness. The bash hooks, the screen scrapes, the status files in `~/.cache`, the separate binary with its own release process — every one of those is a workaround for a door that doesn't open.

That's the question worth stealing from all this, and it has nothing to do with which harness you use: go look at what you've built around yours, and ask how much of it would evaporate if you could write a hundred lines of TypeScript inside it instead.

[NICK: is that the takeaway you'd actually give someone? Rewrite this ending in your words — it's the one paragraph that should sound most like you.]
