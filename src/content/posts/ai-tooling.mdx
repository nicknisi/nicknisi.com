...
3. **It maintains context**. I can be in there making changes right along side it. It adapts the changes and continues.
...
If your experience tells you it can't solve your complex problems and that those who claim clear gains just don't have hard problem to solve, you're wrong. You're just not simplifying your tasks enough or you don't know enough about what success looks like to tell it how to succeed.
