---
title: 'A simple introduction to codemods'
pubDate: 2023-03-10
...
<img src="/img/posts/codemods-ast.png" class="image" alt="an AST representation of our import statement" />
...
const importRender = importDeclaration.find(j.ImportSpecifier, { imported: { name: 'render' } });
```
