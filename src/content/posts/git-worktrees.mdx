...
<Callout type="info">
  You'll need to `npm install` or do whatever to set up your project as you
  normally would, as if this were a new clone.
</Callout>
...
<Callout type="info">
  I created a
  [script](https://github.com/nicknisi/dotfiles/blob/main/bin/git-bare-clone) to
  help make this setup easier.
</Callout>
