...
<div class="not-prose flex flex-wrap items-center gap-3">
	<a href="https://thatconference.com/activities/mnuQbuqqsy40y2WlNjHE" target="_blank" class="btn btn-ghost">
		Conference Web Site
	</a>
	<a href="/talks/unleashing-the-typescript-compiler-that-2024.pdf" target="_blank" class="btn btn-primary">
		Download Slides →
	</a>
	<a href="https://github.com/nicknisi/ts-compiler-api-talk" target="_blank" class="btn btn-ghost">Code examples</a>
</div>
...
<div class="not-prose flex flex-wrap items-center gap-3">
	<a href="https://kcdc.info/" target="_blank" class="btn btn-ghost">Conference Web Site</a>
	<a href="/talks/unleashing-the-typescript-compiler-kcdc-2024.pdf" target="_blank" class="btn btn-primary">
		Download Slides →
	</a>
	<a href="https://github.com/nicknisi/ts-compiler-api-talk" target="_blank" class="btn btn-ghost">Code examples</a>
</div>
