...
<Image alt="My desktop" src={dotfilesImg} class="rounded-[14px] border-2 border-ink shadow-hard-sm" width={1024} height={768} />
...
<Image alt="My desk" src={deskImg} class="rounded-[14px] border-2 border-ink shadow-hard-sm" width={1024} height={768} />
