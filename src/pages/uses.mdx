...
<Image alt="My desktop" src={dotfilesImg} class="rounded-lg border border-line" width={1024} height={768} />
...
<Image alt="My desk" src={deskImg} class="rounded-lg border border-line" width={1024} height={768} />
